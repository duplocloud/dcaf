    ...
    def __init__(
        ...
        if app_env.lower() == "local":
            if not aws_access_key_id or not aws_secret_access_key:
                logger.error(
                    "AWS credentials not found in environment variables. Please make sure .env file is properly configured.")
                raise ValueError(
                    "AWS credentials not found. Set AWS_ACCESS_KEY_ID and AWS_SECRET_ACCESS_KEY in .env file.")
