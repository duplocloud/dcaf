...
class MessageBuilder:
    ...
    def __init__(self) -> None:
        ...
        self._text: Optional[str] = "Test message"
        self._content: Optional[MessageContent] = None
...
class ConversationBuilder:
    ...
    def __init__(self) -> None:
        self._id: Optional[ConversationId] = None
    ...
    def with_single_turn(
        ...
        return (cls()
            ...
            .with_assistant_message(assistant_text)
            .build())
...
class ToolBuilder:
    ...
    def __init__(self) -> None:
        ...
        self._func: Callable = lambda **kwargs: "Tool executed"
...
class MockTool:
    ...
    def __init__(
        ...
        self._func = func or (lambda **kwargs: "Executed")
    ...
    @property
    def last_execute_call(self) -> Optional[Dict[str, Any]]:
