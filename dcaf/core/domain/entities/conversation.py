...
class Conversation:
    ...
    def request_tool_approval(self, tool_calls: List[ToolCall]) -> None:
        ...
        self._record_event(ApprovalRequested(
    ...
    def complete_tool_call(self, tool_call_id: str, result: str) -> ToolCall:
        ...
        self._record_event(ToolExecuted(
            conversation_id=self._id,
            tool_call=tool_call,
            result=result,
        ))
    ...
    @classmethod
    def create(cls, context: Optional[PlatformContext] = None) -> "Conversation":
        ...
        conversation._record_event(ConversationStarted(
