...
class AgnoToolConverter:
    ...
    def to_agno(self, tool: Any) -> AgnoToolDefinition:
        """
    ...
    def to_agno_function(self, tool: Any) -> dict[str, Any]:
        """
        ...
        def wrapped_function(**kwargs: Any) -> str:
    ...
    def _extract_input_schema(self, schema: dict[str, Any]) -> dict[str, Any]:
        ...
        if isinstance(schema, dict) and "input_schema" in schema:
            ...
            return dict(input_schema) if isinstance(input_schema, dict) else {}
