...
def example_basic():
    ...
    response = agent.run([{"role": "user", "content": "What are the three laws of robotics?"}])
...
def example_model_config():
    ...
    response = creative_agent.run([{"role": "user", "content": "Describe AI in one sentence."}])
    ...
    response = factual_agent.run([{"role": "user", "content": "Describe AI in one sentence."}])
    print(f"{response.text}\n")
...
def example_different_models():
    ...
    for model_id, description in models:
        ...
        try:
            response = agent.run([{"role": "user", "content": question}])
